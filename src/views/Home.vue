    ...
    <div>
        ...
        <div>
            ...
            <div v-if="usersData">
                ...
                <div v-for="user in usersData" :key="user.id" class="card border w-96 hover:shadow-none relative flex flex-col mx-auto shadow-lg m-5">
                    ...
                    <!-- кнопка -->
                    <div v-on:click="ShowContact(user.email)" class="buttons flex absolute bottom-0 font-bold right-0 text-xs text-gray-500 space-x-0 my-3.5 mr-3">
