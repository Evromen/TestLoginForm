        ...
        <form class="mt-8 space-y-6" action="#" method="POST">
          ...
          <div class="rounded-md shadow-sm -space-y-px">
            <div>
              ...
              <input id="email-address" name="email" type="email" autocomplete="email" v-model="mail" required
          ...
          <div class="flex items-center justify-between">
            ...
            <div class="text-sm">
              <router-link to="/restorePass" class="font-medium text-indigo-600 hover:text-indigo-500">Забыли пароль?
              </router-link>
            </div>
          </div>
